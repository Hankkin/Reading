 ...
 * @time 15/9/26
 */
public class AppCompatFabMenuHelper extends AppCompatBaseHelper<View> {
    ...
    public AppCompatFabMenuHelper(View view, TintManager tintManager) {
    ...
    public void loadFromAttribute(AttributeSet attrs, int defStyleAttr) {
        initPadding();
        TypedArray array = mView.getContext().obtainStyledAttributes(attrs, R.styleable.TintFabMenugroundHelper, defStyleAttr, 0);
        ...
        }else if(array.hasValue(R.styleable.TintFabMenugroundHelper_normal)){
            normalResId = array.getResourceId(R.styleable.TintFabMenugroundHelper_normal,0);
            setSupportBackgroundTint(mBackgroundTintResId);
        } else{
